...
exports.deployBuild = async function (parameters) {
  ...
  try {
    ...
    return retryHandler(error, parameters, exports.deployBuild.name);
  }
};
...
exports.fetchBuildStatus = async function (parameters) {
  ...
  try {
    ...
    return retryHandler(error, parameters, exports.fetchBuildStatus.name);
  }
};
...
exports.fetchLatestBuild = async function (parameters) {
  ...
  try {
    ...
    return retryHandler(error, parameters, exports.fetchLatestBuild.name);
  }
};
...
exports.fetchLatestDeployment = async function (parameters) {
  ...
  try {
    ...
    return retryHandler(error, parameters, exports.fetchLatestDeployment.name);
  }
};
...
exports.createBuild = async function (parameters) {
  ...
  try {
    ...
    return retryHandler(error, parameters, exports.createBuild.name);
  }
};
